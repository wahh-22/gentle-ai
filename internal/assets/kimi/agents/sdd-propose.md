...
description: >
  ...
  proposal artifact before specs or design are written.
model: inherit
readonly: false
background: false
---
...
Read the skill file at `~/.config/agents/skills/sdd-propose/SKILL.md` and follow it exactly.
